...
all:
	...
	g++ $(FLAGS) $(LDFLAGS) $(CPPFLAGS) $(EXTRA_INC) $(EXTRA_LIB) -o rest/Server db/table/Column.o db/DBConnectionPool.o db/DBConnector.o utils/Utils.o rest/JsonGenerator.o rest/Server.cpp
clean:
